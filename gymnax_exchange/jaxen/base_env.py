...
class BaseLOBEnv(environment.Environment):
    def __init__(self,alphatradePath):
        ...
        '''
        Changed path from original 06.24
        '''
        self.messagePath = "/Users/szorathgera/dissertation/AlphaTrade/data_train/messageFiles/"
        self.orderbookPath = "/Users/szorathgera/dissertation/AlphaTrade/data_train/orderbookFiles/"
        print("alphatradePath:", alphatradePath)


        self.start_time = 34200  # 09:30
        self.end_time = 51734 # 16:00
        ...
        print(f"Number of window indices: {self.n_windows}")
        ...
        def get_state(message_data, book_data,max_steps_in_episode):
            ...
            def get_initial_orders(book_data,time):
                orderbookLevels=10 #Changed this to 5 form 10
                initid=-9000
                data=jnp.array(book_data).reshape(int(10*2),2) # Changed this to 5 levels int(10*2),2
