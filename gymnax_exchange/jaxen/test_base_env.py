...
class BaseLOBEnv(environment.Environment):
    def __init__(self,alphatradePath):
        ...
        '''
        self.messagePath = "/Users/szorathgera/dissertation/AlphaTrade/data_test/messageFiles/"
        self.orderbookPath = "/Users/szorathgera/dissertation/AlphaTrade/data_test/orderbookFiles/"
        print("alphatradePath:", alphatradePath)


        self.start_time = 51733  # 09:30
