...
# Code snippet to disable all jitting.tim
...
class ScannedRNN(nn.Module):
    ...
    def __call__(self, carry, x):
        ...
        #print("shapes:", ins.shape, resets.shape)
...
if __name__ == "__main__":
    ...
    ppo_config = {
        ...
        "ACTION_TYPE": "pure",
        "TASK_SIZE": 500,
        "RESULTS_FILE": f"/Users/szorathgera/Dissertation/AlphaTrade/gymnax_exchange/jaxrl/lstm_ppo_train/results_file_{timestamp}",
        "CHECKPOINT_DIR": f"/Users/szorathgera/Dissertation/AlphaTrade/gymnax_exchange/jaxrl/lstm_ppo_train/checkpoints_{timestamp}",
    }
