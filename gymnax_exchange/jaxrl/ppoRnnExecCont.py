...
class ScannedRNN(nn.Module):
    ...
    def __call__(self, carry, x):
        ...
        print(f"ins.shape: {ins.shape}, resets.shape: {resets.shape}")
    ...
    def initialize_carry(batch_size, hidden_size):
        ...
        print(f"Initializing carry with batch_size={batch_size}, hidden_size={hidden_size}")
...
if __name__ == "__main__":
    ...
    ppo_config = {
        ...
        # "ACTION_TYPE":"delta",
        "TASK_SIZE":500,
        "RESULTS_FILE":"/Users/szorathgera/dissertation/AlphaTrade/results_file_"+f"{timestamp}",
        "CHECKPOINT_DIR":"/Users/szorathgera/dissertation/AlphaTrade/checkpoints_"+f"{timestamp}",
    }
