...
class BaseLOBEnv(environment.Environment):
    def __init__(self,alphatradePath):
        ...
        '''
        self.messagePath = "/Users/szorathgera/dissertation/AlphaTrade/data_train/fx_message/"
        self.orderbookPath = "/Users/szorathgera/dissertation/AlphaTrade/data_train/fx_orderbook/"
        print("alphatradePath:", alphatradePath)


        self.start_time = 884  # 09:30
        self.end_time = 24507  # 16:00
            ...
            def sliceWithoutOverlap(message, orderbook):
                ...
                def splitMessage(message, orderbook):
                    ...
                    for i in range(len(indices) - 1):
                        ...
                        print(np.arange(index_s, index_e))
                        print(message)
