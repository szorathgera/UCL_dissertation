...
class ScannedRNN(nn.Module):
    ...
    def __call__(self, carry, x):
        ...
        rnn_state = jax.tree_map(lambda s, c: jnp.where(resets[:, None], c, s), rnn_state, initial_carry)
...
def make_train(config):
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            initial_hstate = jax.tree_map(lambda x: x[None, :], initial_hstate)  # TBH
            update_state = (
                train_state,
                initial_hstate,
                traj_batch,
...
if __name__ == "__main__":
    ...
    ppo_config = {
        ...
        "ACTION_TYPE": "pure",
        "TASK_SIZE": 500,
        "RESULTS_FILE": f"/Users/szorathgera/dissertation/AlphaTrade/results_file_{timestamp}",
        "CHECKPOINT_DIR": f"/Users/szorathgera/dissertation/AlphaTrade/checkpoints_{timestamp}",
    }
